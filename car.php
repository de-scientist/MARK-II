  ...
  <body>
	...
	<div class="col-md-4">
    				<div class="car-wrap rounded ftco-animate">
    					...
    					<div class="text">
    						<h2 class="mb-0"><a href="car-single.html"><?php echo $car_name; ?></a></h2>
    						...
    						<p class="d-flex mb-0 d-block"><a href="payment.php?plate=<?php echo $plate_number; ?>" class="btn btn-primary py-2 mr-1">Book now</a> <a href="car-single.php?plate=<?php echo $plate_number; ?>" class="btn btn-secondary py-2 ml-1">Details</a></p>
    					</div>
    				</div>
    			</div>
