      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
            ...
            <h1 class="mb-3 bread">Account Login</h1>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="col-md-8 block-9 mb-md-5">
            ...
            if($email !== $db_email){
                ...
                if($password !== $db_pwd){
                    echo "<div style='background-color:#f8f9fa;padding:10px;'><div  class='response_form'>Incorrect password</div></div>";
        ...
        //     }
            ...
            function create_account($username, $password) {
                ...
                // save the hashed password and username to the database
            }
            
            function login($username, $password) {
                $hashed_password = hash('sha256', $password);
                // check the username and hashed password against the database
                // if they match, return a success message, otherwise return an error message
            }
            ?>
               <!-- <p><u>For testing purposes</u></p>
              To login to admin use this email and password.
              <br>
         ...
         <!-- <div id='response_pwd' style='background-color:#f8f9fa;padding:10px;'><div >Passwords do not match</div></div> -->
           ...
           <form action="#" onsubmit='return validate()'  id='target'  method='post' class="bg-light p-5 contact-form">
              ...
              <div class="form-group">
                <input type="submit" value="Login" name='login_user'id='add_user' class="btn btn-primary py-3 px-5">
              </div> 
