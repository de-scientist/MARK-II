...
<html lang="en">
  ...
  <body>
      	...
      	<div class="row justify-content-center">
      		<div class="col-md-12">
      			<div class="car-details">
      				<div class="img rounded" style="background-image: url(images/<?php echo $car_image; ?>);"></div>
      				<div class="text text-center">
      					<span class="subheading"><?php echo  $brand; ?></span>
    ...
    <section class="ftco-section ftco-no-pt">
	  ...
	  $query = "SELECT * FROM cars_db WHERE car_class = '$car_class'";
	  $select_cars = mysqli_query($connection,$query);
	  while($row = mysqli_fetch_assoc($select_cars)){
		  $plate_number = $row['plate_number'];
		  $car_name = $row['car_name'];
    			...
    			<div class="col-md-4">
    				<div class="car-wrap rounded ftco-animate">
    					...
    					<div class="text">
    						...
    						<p class="d-flex mb-0 d-block"><a href="#" class="btn btn-primary py-2 mr-1">Book now</a> <a href="car-single.php?plate=<?php echo $plate_number; ?>" class="btn btn-secondary py-2 ml-1">Details</a></p>
    					</div>
    				</div>
    			</div>
<?php
