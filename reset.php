  ...
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Reset <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread">Account Reset</h1>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="col-md-8 block-9 mb-md-5">
            ...
            while($row = mysqli_fetch_assoc($select_user)){
                $db_email = $row['email'];
                $db_pwd = $row['password'];
                $db_fav = $row['favourite'];

            }
            //check email exist
            if($email !== $db_email){
                echo "<div style='background-color:#f8f9fa;padding:10px;'><div  class='response_form'>User does not exist</div></div>";
            }else{
                //check animal similar
                if($fav !== $db_fav){
                    echo "<div style='background-color:#f8f9fa;padding:10px;'><div  class='response_form'>Try remembering favourite animal </div></div>";  
    ...
    $query = "UPDATE users SET ";
     $query .= " password = '$password'"; 
       ...
       if($update_user){
        echo "<div style='background-color:#f8f9fa;padding:10px;'><div  class='response_form'>Password updated successfully</div></div>";  
       }
        ...
        //     $query = "INSERT INTO users(email,name,mobile_number,password)VALUES('$email','$name','$number','$number')";
        ...
        //     }
         ...
         <div id='response_pwd' style='background-color:#f8f9fa;padding:10px;'><div >Passwords do not match</div></div>
           ...
           <form action="#" onsubmit='return validate()'  id='target'  method='post' class="bg-light p-5 contact-form">
              ...
              <div class="form-group">
                <input type="password" class="form-control" placeholder="Password Repeat"  id="pwd_repeat" required>
              </div>
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Favourite animal" name='fav'  required>
              </div>
              <!-- <div class="form-group">
              ...
              <div class="form-group">
                <input type="submit" value="Reset password" name='update_pwd' id='add_user' class="btn btn-primary py-3 px-5">
              </div> 
